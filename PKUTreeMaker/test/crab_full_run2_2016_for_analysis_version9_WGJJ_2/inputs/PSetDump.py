...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer16MiniAODv3/ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3_ext1-v1/270000/0C8C71F6-4DC2-E811-838D-0025901C1B7E.root'),
...
process.JetUserData = cms.EDProducer("JetUserData",
    ...
    resolutionsFile = cms.string('Summer16_07Aug2017_V11_MC_PtResolution_AK4PFchs.txt'),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    scaleFactorsFile = cms.string('Summer16_07Aug2017_V11_MC_SF_AK4PFchs.txt'),
...
process.egmPhotonIsolation = cms.EDProducer("CITKPFIsolationSumProducer",
    ...
    srcToIsolate = cms.InputTag("updatedPhotons")
)
...
process.heepIDVarValueMaps = cms.EDProducer("ElectronHEEPIDValueMapProducer",
    ...
    elesMiniAOD = cms.InputTag("updatedElectrons"),
...
process.egammaUpdatorTask = cms.Task(process.updatedElectrons, process.updatedPhotons)
...
process.leptonSequence = cms.Sequence(process.muSequence+process.egammaPostRecoSeq+process.eleSequence+process.leptonicVSequence+process.leptonicVSelector+process.leptonicVFilter)
