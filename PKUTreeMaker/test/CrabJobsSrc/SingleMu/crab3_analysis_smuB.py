...
config.General.requestName   = 'full_run2_2017_for_analysis_PUJetID_version5_smuB_v1'
...
config.Data.outputDatasetTag = 'full_run2_2017_for_analysis_PUJetID_version5_smuB_v1'
