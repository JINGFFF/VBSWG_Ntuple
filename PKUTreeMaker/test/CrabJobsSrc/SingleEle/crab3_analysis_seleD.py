...
config.General.requestName   = 'full_run2_2017_loose_for_analysis_pujetID_version5_loose_seleD'
...
config.Data.outputDatasetTag = 'full_run2_2017_loose_for_analysis_pujetID_version5_loose_seleD'
