...
config.General.requestName   = 'full_run2_2016_loose_version7_TGJets_leptonDecays'
...
config.Data.outputDatasetTag = 'full_run2_2016_loose_version7_TGJets_leptonDecays'
