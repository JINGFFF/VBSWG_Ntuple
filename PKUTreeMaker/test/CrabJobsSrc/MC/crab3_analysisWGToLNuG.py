...
config.General.requestName   = 'full_run2_2016_for_analysis_version7_WGToLNuG_1'
...
config.Data.outputDatasetTag = 'full_run2_2016_for_analysis_version7_WGToLNuG_1'
