...
config.General.requestName   = 'full_run2_2016_loose_version7_LNuAJJ_Interference'
...
config.Data.outputDatasetTag = 'full_run2_2016_loose_version7_LNuAJJ_Interference'
