...
config.General.requestName   = 'full_run2_2016_for_analysis_version7_ST_tW_antitop'
...
config.Data.outputDatasetTag = 'full_run2_2016_for_analysis_version7_ST_tW_antitop'
