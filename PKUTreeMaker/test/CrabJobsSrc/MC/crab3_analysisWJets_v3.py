...
config.General.requestName   = 'full_run2_2017_for_analysis_version5_WJets_1j_v2'
...
config.Data.outputDatasetTag = 'full_run2_2017_for_analysis_version5_WJets_1j_v2'
