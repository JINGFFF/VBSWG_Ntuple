...
config.General.requestName   = 'full_run2_2017_for_analysis_PUJetID_version5_DY_v1_2'
...
config.Data.outputDatasetTag = 'full_run2_2017_for_analysis_PUJetID_version5_DY_v1_2'
