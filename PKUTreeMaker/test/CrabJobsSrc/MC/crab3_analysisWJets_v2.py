...
config.General.requestName   = 'full_run2_2016_for_analysis_version7_WJets_2'
...
config.Data.outputDatasetTag = 'full_run2_2016_for_analysis_version7_version2_WJets_2'
